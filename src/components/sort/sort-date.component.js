...
export default class VoyagesList extends Component {
  ...
  render() {
    return (
      <div>
        <h2 className="my-voyages-header">Sort Date By:</h2> 
        <h6>
        </h6>
        <br />
        <br />
        <table className="sort-by--table table-striped">
          <tbody>
            <tr>
              <Link to="/sort-date-newest" className="sort-by">Newest </Link>
            </tr>
            <tr>
              <Link to="/sort-date-oldest" className="sort-by">Oldest </Link>
            </tr>
            <tr>
              <Link to="/sort-date-future" className="sort-by">Future </Link>
            </tr>
            <tr>
              <Link to="/sort-date-past" className="sort-by">Past </Link>
            </tr>
          </tbody>
        </table>
      </div>
