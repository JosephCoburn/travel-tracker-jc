...
export default class VoyagesList extends Component {
  ...
  voyageList() {
    return this.state.voyages.map(currentvoyage => {
      if (currentvoyage.country === "Saint Vincent and the Grenadines" || "Saint Vincent and The Grenadines" || "Saint Vincent" || "the Grenadines" || "Grenadine Islands" || "Grenadines" || "The Grenadine Islands" || "the Grenadine Islands" || "The Grenadines" || "St Vincent and the Grenadines" || "St Vincent and The Grenadines" || "St. Vincent and The Grenadines" || "St. Vincent and the Grenadines" || "St Vincent" || "St. Vincent") {
