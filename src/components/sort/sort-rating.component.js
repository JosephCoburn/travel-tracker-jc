...
export default class VoyagesList extends Component {
  ...
  render() {
    return (
      <div>
        <h2 className="my-voyages-header">Sort Rating By:</h2> 
        <h6>
        </h6>
        <br />
        <br />
        <table className="sort-by--table table-striped">
          <tbody>
            <tr>
              <Link to="/sort-rating-highest" className="sort-by">Highest </Link>
            </tr>
            <tr>
              <Link to="/sort-rating-lowest" className="sort-by">Lowest </Link>
            </tr>
          </tbody>
        </table>
      </div>
